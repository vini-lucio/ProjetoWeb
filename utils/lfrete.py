...
pedidos = """
    SELECT
        ...
        CASE WHEN PEDIDOS_ITENS.ANALISE_PIS = 0 THEN 0 ELSE 0.65 END * (1 - (PEDIDOS_ITENS.ICMS_ALIQUOTA * CASE WHEN PEDIDOS_ITENS.DESTINO_MERCADORIAS != 'CONSUMO' THEN 1 ELSE 1 + PEDIDOS_ITENS.ALIQUOTA_IPI / 100 END / 100)) AS ALIQUOTA_PIS,
        ...
        CASE WHEN PEDIDOS_ITENS.ANALISE_COFINS = 0 THEN 0 ELSE 3 END * (1 - (PEDIDOS_ITENS.ICMS_ALIQUOTA * CASE WHEN PEDIDOS_ITENS.DESTINO_MERCADORIAS != 'CONSUMO' THEN 1 ELSE 1 + PEDIDOS_ITENS.ALIQUOTA_IPI / 100 END / 100)) AS ALIQUOTA_COFINS,
        ...
        (PEDIDOS_ITENS.ICMS_ALIQUOTA + CASE WHEN CLIENTES.ISENTO_INSCRICAO = 'SIM' AND PEDIDOS_ITENS.DESTINO_MERCADORIAS = 'CONSUMO' THEN (SELECT ALIQUOTA_FCP FROM COPLAS.MATRIZ_ICMS WHERE UF_EMITENTE = UF_DESTINO AND UF_EMITENTE = COALESCE(PLATAFORMAS.UF_ENT, CLIENTES.UF)) ELSE 0 END + CASE WHEN PEDIDOS_ITENS.ANALISE_ICMS_PARTILHA = 0 THEN 0 ELSE (SELECT ALIQUOTA FROM COPLAS.MATRIZ_ICMS WHERE UF_EMITENTE = UF_DESTINO AND UF_EMITENTE = COALESCE(PLATAFORMAS.UF_ENT, CLIENTES.UF)) - PEDIDOS_ITENS.ICMS_ALIQUOTA END) * CASE WHEN PEDIDOS_ITENS.DESTINO_MERCADORIAS != 'CONSUMO' THEN 1 ELSE 1 + PEDIDOS_ITENS.ALIQUOTA_IPI / 100 END AS ALIQUOTA_ICMS,
        ...
        CASE WHEN PEDIDOS_ITENS.ANALISE_CONTRIBUICAO = 0 THEN 0 ELSE 2 END AS ALIQUOTA_IR,
        ...
        CASE WHEN PEDIDOS_ITENS.ANALISE_CONTRIBUICAO = 0 THEN 0 ELSE 1.08 END AS ALIQUOTA_CSLL,
        ...
        PEDIDOS_ITENS.COMISSAO_PADRAO_PERC AS ALIQUOTA_COMISSAO,
        ...
        PEDIDOS_ITENS.ANALISE_DESPESAS_ADM / PEDIDOS_ITENS.VALOR_TOTAL * 100 AS ALIQUOTA_DESPESA_ADM,
        ...
        PEDIDOS_ITENS.ANALISE_DESPESAS_COM / PEDIDOS_ITENS.VALOR_TOTAL * 100 AS ALIQUOTA_DESPESA_COM,
    ...
    WHERE
        -- PEDIDOS.DATA_PEDIDO >= TRUNC(SYSDATE) - 30 AND
        ...
        PEDIDOS.CHAVE = PEDIDOS_ITENS.CHAVE_PEDIDO
"""
...
notas = """
    SELECT
        ...
        CASE WHEN NOTAS_ITENS.ANALISE_PIS = 0 THEN 0 ELSE 0.65 END * (1 - (NOTAS_ITENS.ICMS_ALIQUOTA * CASE WHEN NOTAS_ITENS.DESTINO_MERCADORIAS != 'CONSUMO' THEN 1 ELSE (1 + (NOTAS_ITENS.IPI_ALIQUOTA / 100)) END / 100)) AS ALIQUOTA_PIS,
        ...
        CASE WHEN NOTAS_ITENS.ANALISE_COFINS = 0 THEN 0 ELSE 3 END * (1 - (NOTAS_ITENS.ICMS_ALIQUOTA * CASE WHEN NOTAS_ITENS.DESTINO_MERCADORIAS != 'CONSUMO' THEN 1 ELSE (1 + (NOTAS_ITENS.IPI_ALIQUOTA / 100)) END / 100)) AS ALIQUOTA_COFINS,
        ...
        (NOTAS_ITENS.ICMS_ALIQUOTA + CASE WHEN CLIENTES.ISENTO_INSCRICAO = 'SIM' AND NOTAS_ITENS.DESTINO_MERCADORIAS = 'CONSUMO' THEN (SELECT ALIQUOTA_FCP FROM COPLAS.MATRIZ_ICMS WHERE UF_EMITENTE = UF_DESTINO AND UF_EMITENTE = COALESCE(PLATAFORMAS.UF_ENT, CLIENTES.UF)) ELSE 0 END + CASE WHEN NOTAS_ITENS.ANALISE_ICMS_PARTILHA = 0 THEN 0 ELSE (SELECT ALIQUOTA FROM COPLAS.MATRIZ_ICMS WHERE UF_EMITENTE = UF_DESTINO AND UF_EMITENTE = COALESCE(PLATAFORMAS.UF_ENT, CLIENTES.UF)) - NOTAS_ITENS.ICMS_ALIQUOTA END) * CASE WHEN NOTAS_ITENS.DESTINO_MERCADORIAS != 'CONSUMO' THEN 1 ELSE (1 + (NOTAS_ITENS.IPI_ALIQUOTA / 100)) END AS ALIQUOTA_ICMS,
        ...
        CASE WHEN NOTAS_ITENS.ANALISE_CONTRIBUICAO = 0 THEN 0 ELSE 2 END AS ALIQUOTA_IR,
        ...
        CASE WHEN NOTAS_ITENS.ANALISE_CONTRIBUICAO = 0 THEN 0 ELSE 1.08 END AS ALIQUOTA_CSLL,
        ...
        NOTAS_ITENS.COMISSAO_PADRAO_PERC AS ALIQUOTA_COMISSAO,
        ...
        NOTAS_ITENS.ANALISE_DESPESAS_ADM / NOTAS_ITENS.VALOR_MERCADORIAS * 100 AS ALIQUOTA_DESPESA_ADM,
        ...
        NOTAS_ITENS.ANALISE_DESPESAS_COM / NOTAS_ITENS.VALOR_MERCADORIAS * 100 AS ALIQUOTA_DESPESA_COM,
    ...
    WHERE
        -- NOTAS.DATA_EMISSAO >= TRUNC(SYSDATE) - 30 AND
        ...
        PRODUTOS.CHAVE_FAMILIA IN (7766, 7767, 8378, 12441, 12819)
"""
...
orcamentos = """
    SELECT
        ...
        CASE WHEN ORCAMENTOS_ITENS.ANALISE_PIS = 0 THEN 0 ELSE 0.65 END * (1 - (ORCAMENTOS_ITENS.ALIQUOTA_ICMS * CASE WHEN ORCAMENTOS_ITENS.DESTINO_MERCADORIAS != 'CONSUMO' THEN 1 ELSE 1 + ORCAMENTOS_ITENS.ALIQUOTA_IPI / 100 END / 100)) AS ALIQUOTA_PIS,
        ...
        CASE WHEN ORCAMENTOS_ITENS.ANALISE_COFINS = 0 THEN 0 ELSE 3 END * (1 - (ORCAMENTOS_ITENS.ALIQUOTA_ICMS * CASE WHEN ORCAMENTOS_ITENS.DESTINO_MERCADORIAS != 'CONSUMO' THEN 1 ELSE 1 + ORCAMENTOS_ITENS.ALIQUOTA_IPI / 100 END / 100)) AS ALIQUOTA_COFINS,
        ...
        (ORCAMENTOS_ITENS.ALIQUOTA_ICMS + CASE WHEN CLIENTES.ISENTO_INSCRICAO = 'SIM' AND ORCAMENTOS_ITENS.DESTINO_MERCADORIAS = 'CONSUMO' THEN (SELECT ALIQUOTA_FCP FROM COPLAS.MATRIZ_ICMS WHERE UF_EMITENTE = UF_DESTINO AND UF_EMITENTE = COALESCE(PLATAFORMAS.UF_ENT, CLIENTES.UF)) ELSE 0 END + CASE WHEN ORCAMENTOS_ITENS.ANALISE_ICMS_PARTILHA = 0 THEN 0 ELSE (SELECT ALIQUOTA FROM COPLAS.MATRIZ_ICMS WHERE UF_EMITENTE = UF_DESTINO AND UF_EMITENTE = COALESCE(PLATAFORMAS.UF_ENT, CLIENTES.UF)) - ORCAMENTOS_ITENS.ALIQUOTA_ICMS END) * CASE WHEN ORCAMENTOS_ITENS.DESTINO_MERCADORIAS != 'CONSUMO' THEN 1 ELSE 1 + ORCAMENTOS_ITENS.ALIQUOTA_IPI / 100 END AS ALIQUOTA_ICMS,
        ...
        CASE WHEN ORCAMENTOS_ITENS.ANALISE_CONTRIBUICAO = 0 THEN 0 ELSE 2 END AS ALIQUOTA_IR,
        ...
        CASE WHEN ORCAMENTOS_ITENS.ANALISE_CONTRIBUICAO = 0 THEN 0 ELSE 1.08 END AS ALIQUOTA_CSLL,
        ...
        ORCAMENTOS_ITENS.COMISSAO_PADRAO_PERC AS ALIQUOTA_COMISSAO,
        ...
        ORCAMENTOS_ITENS.ANALISE_DESPESAS_ADM / ORCAMENTOS_ITENS.VALOR_TOTAL * 100 AS ALIQUOTA_DESPESA_ADM,
        ...
        ORCAMENTOS_ITENS.ANALISE_DESPESAS_COM / ORCAMENTOS_ITENS.VALOR_TOTAL * 100 AS ALIQUOTA_DESPESA_COM,
    ...
    WHERE
        -- ORCAMENTOS.DATA_PEDIDO >= TRUNC(SYSDATE) - 30 AND
        ...
        ORCAMENTOS.CHAVE = ORCAMENTOS_ITENS.CHAVE_PEDIDO
"""
