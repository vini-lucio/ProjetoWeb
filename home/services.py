...
def i4ref_custo_materia_prima_vendido_ano_mes_a_mes():
    ...
    sql = """
        SELECT
            ...
            SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) THEN CUSTO_MP.CUSTO_MP * NOTAS_ITENS.QUANTIDADE ELSE 0 END) AS CUSTO_MP_PT,
            SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA = 8378 THEN CUSTO_MP.CUSTO_MP * NOTAS_ITENS.QUANTIDADE ELSE 0 END) AS CUSTO_MP_PQ,
            SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) AND PRODUTOS.CHAVE_MARCA = 181 THEN CUSTO_MP.CUSTO_MP * NOTAS_ITENS.QUANTIDADE ELSE 0 END) AS CUSTO_MP_PT_NC4,
            SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) AND PRODUTOS.CHAVE_MARCA != 181 THEN CUSTO_MP.CUSTO_MP * NOTAS_ITENS.QUANTIDADE ELSE 0 END) AS CUSTO_MP_PT_SEM_NC4
...
def imposto_faturado_ano_mes_a_mes():
    ...
    sql = """
        SELECT
            ...
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) THEN NOTAS_ITENS.VALOR_IPI_COM_FRETE ELSE 0 END), 2) AS IPI_PT,
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) THEN NOTAS_ITENS.ICMS_SUBSTITUICAO_VALOR ELSE 0 END), 2) AS ST_PT,
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) THEN NOTAS_ITENS.ANALISE_ICMS ELSE 0 END), 2) AS ICMS_PT,
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) THEN NOTAS_ITENS.ANALISE_PIS ELSE 0 END), 2) AS PIS_PT,
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) THEN NOTAS_ITENS.ANALISE_COFINS ELSE 0 END), 2) AS COFINS_PT,
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) THEN NOTAS_ITENS.ANALISE_CONTRIBUICAO ELSE 0 END), 2) AS IRPJ_CSLL_PT,
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) THEN NOTAS_ITENS.ANALISE_ICMS_PARTILHA ELSE 0 END), 2) AS ICMS_PARTILHA_PT,
...
def faturado_bruto_ano_mes_a_mes(*, mes_atual: bool = False):
    ...
    sql = """
        SELECT
            ...
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) THEN NOTAS_ITENS.VALOR_CONTABIL ELSE 0 END), 2) AS FATURADO_PT,
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA = 8378 THEN NOTAS_ITENS.VALOR_CONTABIL ELSE 0 END), 2) AS FATURADO_PQ,
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7766, 7767, 8378, 12441) THEN NOTAS_ITENS.VALOR_CONTABIL ELSE 0 END), 2) AS FATURADO_TOTAL
...
def custo_materia_prima_faturada_ano_mes_a_mes():
    ...
    sql = """
        SELECT
            ...
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) THEN CUSTO_MP.CUSTO_MP * NOTAS_ITENS.QUANTIDADE ELSE 0 END), 2) AS CUSTO_MP_PT,
            ...
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) AND PRODUTOS.CHAVE_MARCA = 181 THEN CUSTO_MP.CUSTO_MP * NOTAS_ITENS.QUANTIDADE ELSE 0 END), 2) AS CUSTO_MP_PT_NC4,
            ROUND(SUM(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) AND PRODUTOS.CHAVE_MARCA != 181 THEN CUSTO_MP.CUSTO_MP * NOTAS_ITENS.QUANTIDADE ELSE 0 END), 2) AS CUSTO_MP_PT_SEM_NC4
        ...
        FROM
            (
                SELECT
                    ...
                    CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) THEN MOVESTOQUE.SALDO_ESTOQUE ELSE 0 END AS ESTOQUE_PT,
            ...
            (
                SELECT
                    ...
                    ROUND(AVG(CASE WHEN PRODUTOS.CHAVE_FAMILIA IN (7767, 12441) THEN NOTAS_ITENS.PRECO_FATURADO ELSE 0 END), 2) AS PRECO_MEDIO_PT,
                ...
                FROM
                    ...
                    (
                        ...
                        WHERE
                            ...
                            PRODUTOS.CHAVE_FAMILIA = 7766 AND
                            MATERIAIS.CHAVE_FAMILIA NOT IN (7766, 7767, 8378, 12441)
                    ) MATERIAIS,
                    (
                        SELECT
                            PERIODO.MES,
