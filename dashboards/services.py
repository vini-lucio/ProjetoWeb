            ...
            (
                SELECT DISTINCT
                    ...
                    CASE
                        ...
                        WHEN ORCAMENTOS.CHAVE_TRANSPORTADORA = 6766 AND ORCAMENTOS.COBRANCA_FRETE NOT IN (4, 5) THEN 'PARA TRANSPORTADORA COPLAS TIPO DE FRETE DEVE SER "TRANSPORTE PROPRIO COM / SEM COBRANCA DE FRETE"'
                        WHEN ORCAMENTOS.CHAVE_TRANSPORTADORA != 6766 AND ORCAMENTOS.COBRANCA_FRETE IN (4, 5) THEN 'PARA TRANSPORTADORAS TIPO DE FRETE NAO DEVE SER "TRANSPORTE PROPRIO COM / SEM COBRANCA DE FRETE"'
            ...
            (
                SELECT DISTINCT
                    ...
                    CASE
                        ...
                        WHEN PEDIDOS.CHAVE_TRANSPORTADORA = 6766 AND PEDIDOS.COBRANCA_FRETE NOT IN (4, 5) THEN 'PARA TRANSPORTADORA COPLAS TIPO DE FRETE DEVE SER "TRANSPORTE PROPRIO COM / SEM COBRANCA DE FRETE"'
                        WHEN PEDIDOS.CHAVE_TRANSPORTADORA != 6766 AND PEDIDOS.COBRANCA_FRETE IN (4, 5) THEN 'PARA TRANSPORTADORAS TIPO DE FRETE NAO DEVE SER "TRANSPORTE PROPRIO COM / SEM COBRANCA DE FRETE"'
